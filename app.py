...
st.title("langchian- chat with search")
...
if prompt:=st.chat_input(placeholder="what is machine learning?"):
    ...
    search_agent = initialize_agent(tools,llm,agent=AgentType.ZERO_SHOT_REACT_DESCRIPTION,handling_parsing_errors=True,max_iterations = 3,early_stopping_method="generate",verbose=True)
